 ...
 */
public class LeafImpactAdapter extends BaseAdapter {
    private Context context;
    private List<CropDiseases> diseasesList;

    public LeafImpactAdapter(Context context, List<CropDiseases> diseasesList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = LayoutInflater.from(context).inflate(R.layout.leaf_disease_row, parent, false);
        }
        ...
        imgDisease.setImageResource(R.drawable.disease1);
