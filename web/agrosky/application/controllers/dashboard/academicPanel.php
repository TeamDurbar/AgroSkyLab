...
class academicPanel extends CI_Controller {
    ...
    public function message() {
        ...
        $data['mess'] = $this->institution_m->select_all_message_academic();
        $data['maincontain'] = $this->load->view('dboard/academic', $data, TRUE);
    ...
    public function message_edit($id) {
        ...
        $data['maincontain'] = $this->load->view('dboard/academicEdit', $data, TRUE);
        $this->load->view('dboard/master', $data);
    }
