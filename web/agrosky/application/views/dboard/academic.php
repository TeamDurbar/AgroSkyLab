<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal"   method="POST" action="<?php echo base_url(); ?>academic/save_message" enctype="multipart/form-data" >
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label">Illegal Crop</label>
                        <div class="controls">
                            <label class="checkbox inline">
                                <input type="checkbox" name="illegal" id="inlineCheckbox1" value="1"> Agree
                            </label>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <?php foreach ($mess as $v_mess) { ?>
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo base_url() . "academic/message_edit/" . $v_mess->id; ?>">
                                    <i class="halflings-icon white edit"></i>  
                                </a>
                                <a class="btn btn-danger" onclick="return check_delete();"  href="<?php echo base_url() . "academic/message_delete/" . $v_mess->id; ?> ">
