...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal"   method="POST" action="<?php echo base_url(); ?>dboardResult/dboardResult_save" enctype="multipart/form-data" >
                <fieldset>
...
<div class="row-fluid sortable">		
    ...
    <?php } ?>
                            ...
                            <td class="center">
                                ...
                                <a class="btn btn-info" href="<?php echo base_url() . "dboardResult/dboardResult_edit/" . $v_mess->id; ?>">
                                    <i class="halflings-icon white edit"></i>  
                                </a>
                                <a class="btn btn-danger" onclick="return check_delete();"  href="<?php echo base_url() . "dboardResult/dboardResult_delete/" . $v_mess->id; ?> ">
