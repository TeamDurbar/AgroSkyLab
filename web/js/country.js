...
function printCityOptions()
{
	for(key in cityDistrict)
	{
		document.write('<option value="' + key + '">' + cityDistrict[key] + '</option>');
	}
}
function printCity(sta)
{
	for(key in cityDistrict)
	{
            if(sta.match(key)){
                document.write('<option selected="selected" value="' + key + '">' + cityDistrict[key] + '</option>');
            }else{
                document.write('<option value="' + key + '">' + cityDistrict[key] + '</option>');
            }
...
function printState(sta)
{
	for(key in states)
	{
            if(sta.match(key)){
                document.write('<option selected="selected" value="' + key + '">' + states[key] + '</option>');
            }else{
                document.write('<option value="' + key + '">' + states[key] + '</option>');
            }
...
function printCountry(ddr)
{
	for(key in countrys)
	{
            if(ddr.match(key)){
                document.write('<option selected="" value="' + key + '">' +countrys[key] + '</option>');
            }else{
                document.write('<option value="' + key + '">' +countrys[key] + '</option>');
            }
...
function printreligionOptions()
{
	for(key in religion)
	{
		document.write('<option value="' + key + '">' +religion[key] + '</option>');
	}
}
function printreligion(ddr)
{
	for(key in religion)
	{
            if(ddr.match(key)){
                document.write('<option selected="selected" value="' + key + '">' +religion[key] + '</option>');
            }else{
                document.write('<option value="' + key + '">' +religion[key] + '</option>');
            }
